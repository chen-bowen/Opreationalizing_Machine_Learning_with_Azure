...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer REPLACE_WITH_KEY' http://05de123b-0803-4c6c-8b0b-6ba84fed26af.southcentralus.azurecontainer.io/score
